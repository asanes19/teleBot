...
keyword_responses = {
    'لينك': "USDT Wallet Address(TRC 20): TBZk9uTJ2WzMMh4XjJLYwTV3ynr12Rboe9",
    'تاكيد': "هل تريد الاستمرار؟",
    'لا': "حسنا يمكنك دائما بدا عمليات البيع والشراء عن طريق ادخال كلمة 'بدا'",
    'نعم_شراء': "الرجاء مسح الكود للقيام بالتحويل وبعدها ارسل صورة التحويل ورقم محفظة ال USDT .الخاصة بك وبعد الانتهاء ادخل كلمة 'تم' لاغلاق العملية.",
    'نعم_بيع': "الرجاء مسح الكود للقيام بالتحويل وبعدها ارسل صورة التحويل ورقم محفظة زين كاش الخاصة بك. وبعد الانتهاء ادخل كلمة 'تم' لاغلاق العملية",
